...
from python_oop.workshops.custom_list.array_list import ArrayList
...
class TestArrayList(TestCase):
    ...
    def test_append__expect_to_retrun_the_list(self):
        result = self.al.append(1)
        self.assertEqual(self.al, result)

    def test_append__when_list_is_not_empty__expect_append_to_the_end(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        values = list(self.al)
    ...
    def test_remove__when_index_is_valid__expect_to_remove_value_and_return_it(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_remove__when_index_is_not_valid__expect_to_raise_exception(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_get__when_index_is_not_valid__expect_to_raise_exception(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_extend__with_not_iterable__expect_to_raise_exception(self):
        self.al.append(1)
    ...
    def test_insert__when_index_is_valid__expect_to_place_value_at_index(self):
        ...
        self.al.insert(3, 333)
        self.assertListEqual([1, 2, 3, 333, 4, 5, 6, 7, 8, 9], list(self.al))

    def test_insert__when_index_is_not_valid__expect_to_raise_exception(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_pop__when_empty__expect_to_raise_exception(self):
        with self.assertRaises(IndexError):
            self.al.pop()
    ...
    def test_index__when_item_is_not_present__expect_raise_exception(self):
        [self.al.append(x) for x in range(15)]
    ...
    def test_dictionize__when_even_elements_count__expect_empty_correct_result(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_dictionize__when_odd_elements_count__expect_empty_correct_result(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
    ...
    def test_move__when_moving_1_element__expect_to_move_1_element_from_the_start_to_the_end(self):
        ...
        self.al.move(1)
        self.assertListEqual([2, 3, 4, 5, 1], list(self.al))

    def test_move__when_moving_3_elements__expect_to_move_3_elements_from_the_start_to_the_end(self):
        self.al.append(1)
        self.al.append(2)
        self.al.append(3)
        self.al.append(4)
        ...
        self.al.move(3)
        self.assertListEqual([4, 5, 1, 2, 3], list(self.al))

    def test_move__when_moving_3_elements_and_have_2_elements__expect_to_move_3_elements_from_the_start_to_the_end(self):
        self.al.append(1)
        self.al.append(2)
