...
from python_oop.workshops.custom_list.linked_list import LinkedList
...
class TestLinkedList(TestCase):
    ...
    def test_attributes(self):
        self.assertEqual(None, self.al.head)
        self.assertEqual(None, self.al.tail)
        self.assertEqual(0, self.al.values_count)
